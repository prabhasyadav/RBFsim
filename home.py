...
def app():
    ...
    undergoing filtration, sorption, and biodegradation processes along its flowpath to the RBF wells.
    This is leading to a reduction of costs of further water treatment. Although RBF has been
